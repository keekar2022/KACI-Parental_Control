	...
	<?php else: ?>
		...
		<div class="block-body">
			...
			<div class="info-grid">
				...
				<div class="info-item">
					<div class="label"><i class="fa fa-gamepad"></i> Gaming Today</div>
				...
				<div class="info-item">
					<div class="label"><i class="fa fa-heartbeat"></i> WHO Limit</div>
					<div class="value">
				...
				<div class="info-item">
					<div class="label"><i class="fa fa-trophy"></i> Platform</div>
					<div class="value" style="font-size: 16px;">
				...
				<div class="info-item">
					<div class="label"><i class="fa fa-info-circle"></i> Note</div>
